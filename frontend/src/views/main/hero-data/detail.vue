<template>
  <div class="w-full p-2">
    <el-scrollbar height="610px" v-loading="isLoading">
          ...
          <div class="flex">
            ...
            <div class="ml-4 flex flex-col justify-end">
              ...
              <div class="flex">
                ...
                <img class="border-black mr-2 h-[30px] w-[30px]" :src="champion.data.summary.meta.spells[0].image_url" alt="" />
                <img class="border-black mr-2 h-[30px] w-[30px]" :src="champion.data.summary.meta.spells[1].image_url" alt="" />
                <img class="border-black mr-2 h-[30px] w-[30px]" :src="champion.data.summary.meta.spells[2].image_url" alt="" />
                <img class="border-black mr-2 h-[30px] w-[30px]" :src="champion.data.summary.meta.spells[3].image_url" alt="" />
              </div>
            </div>
          </div>
      ...
      <a-card>
        ...
        <a-row align="center">
          <a-col :span="16">
            <div class="flex">
              <img
                class="w-[42px] h-[42px] ml-2 border-gray-900 border-black"
        ...
        <a-row align="center">
          <a-col :span="16">
            <div class="flex">
              <img
                class="w-[42px] h-[42px] ml-2 border-gray-900 border-black"
                v-for="(item, index) in champion.data.summoner_spells[1].ids"
                :key="index"
                :src="findDetailObj('spells', item).image_url"
              />
            </div>
      ...
      <a-card class="mt-2">
        ...
        <a-row align="center">
              ...
              <tbody>
                ...
                <tr class="border-t">
                  <td
                    ...
                    v-for="(item, index) in champion.data.skills[0].order"
                    :key="index"
                  >
                    {{ item }}
                  </td>
          ...
          <a-col :span="4">{{ ((champion.data.skills[0].win / champion.data.skills[0].play) * 100).toFixed(2) }}%</a-col>
        </a-row>
      </a-card>
      <!-- 出门装 -->
      <a-card class="mt-2">
          ...
          <a-row align="center">
            <a-col :span="16">
              <div class="flex">
                <img
                  class="w-[42px] h-[42px] ml-2 border-gray-900 border-black"
                  v-for="(core_item_item, item_index) in core_item.ids"
                  :key="item_index"
            ...
            <a-col :span="16">
              <div class="flex">
                <div class="flex flex-col justify-center items-center font-bold w-[60px]">
                  <img class="w-[28px] h-[28px] mb-1" :src="findDetailObj('runePages', core_item.primary_page_id).image_url" />
                  <span>主系</span>
                </div>
                <div class="flex">
                  <img
              ...
              <div class="flex mt-2">
                <div class="flex flex-col justify-center items-center font-bold w-[60px]">
                  <img class="w-[28px] h-[28px] mb-1" :src="findDetailObj('runePages', core_item.secondary_page_id).image_url" />
                  <span>副系</span>
                </div>
                <div class="flex">
                  <img
...
onBeforeMount(async () => {
  ...
  const championResp = await ipcRenderer.invoke('controller.opgg.getDetailByPositionAndName', route.query);
  isLoading.value = false;
  useMessage(championResp, '获取英雄详情成功');
