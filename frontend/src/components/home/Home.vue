            ...
            <div class="flex h-full flex-col w-full">
              ...
              <div class="mt-5 flex items-center justify-between w-full">
                <div
                  ...
                  v-for="(item, index) in currentSummoner.championMastery.masteries"
                  :key="index"
                >
...
onMounted(async () => {
  loading.value = true
  currentSummoner.value =  await ipcRenderer.invoke('controller.lcuHandle.currentSummonerInfo', {})
...
ipcRenderer.ipc.on('playerStatus', (event, data) => {
