<template>
  <div class="h-full w-full">
    ...
    <div class="relative z-10">
      ...
      <!-- 介绍 -->
      <div class="absolute text-light-50 font-bold text-xl bottom-6 left-3 ]">{{ champion.data.summary.meta.name }}
      </div>
 ...
 */
const hideWin = async () => {
  ipcRenderer.send('championRuneWindow.hide')
};
