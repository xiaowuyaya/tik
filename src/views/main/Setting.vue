<template>
  <div class="w-full h-full flex">
    <div class="flex flex-col w-[60%] h-full !mr-1">
      <a-form :model="configStore">
        <a-card :hoverable="true" :header-style="{ border: 'none' }">
          <a-form-item class="!mb-0" label-col-flex="90px" label="黑名单提醒">
            <a-space size="large">
              <a-radio v-model="configStore.blacklistNoticeAll" :value="true" @change="configStore.changeConfig" >所有人可见</a-radio>
              <a-radio v-model="configStore.blacklistNoticeAll" :value="false" @change="configStore.changeConfig" >仅自己可见</a-radio>
            </a-space>
          </a-form-item>
          ...
          <a-row :gutter="12" align="center" justify-content="space-between">
            <!-- 快捷键发送 -->
            <a-col :span="6">
              <a-form-item class="!mb-0" label-col-flex="90px" label="快捷键发送">
            ...
            <!-- 仅显示排位数据 -->
            <a-col :span="6">
              <a-form-item class="!mb-0" label-col-flex="100px" label="仅显示排位数据">
            ...
            <!--  -->
            <a-col :span="6">
              <a-form-item class="!mb-0" label-col-flex="90px" label="发送局数">
                <a-input-number v-model="configStore.matchCount" class="input-demo" :min="1" :max="10"  @change="configStore.changeConfig" />
              </a-form-item>
            </a-col>
          </a-row>
        </a-card>
          ...
          <a-row align="center">
            <a-col :span="8">
              <a-form-item label-col-flex="50px" label="第一">
                <a-input v-model="configStore.typeTitle[0]" placeholder="请输入该排名称号" allow-clear  @change="configStore.changeConfig" />
              </a-form-item>
            </a-col>
            <a-col :span="8">
              <a-form-item label-col-flex="50px" label="第二">
                <a-input v-model="configStore.typeTitle[1]" placeholder="请输入该排名称号" allow-clear  @change="configStore.changeConfig" />
              </a-form-item>
            </a-col>
            <a-col :span="8">
              <a-form-item label-col-flex="50px" label="第三">
                <a-input v-model="configStore.typeTitle[2]" placeholder="请输入该排名称号" allow-clear  @change="configStore.changeConfig" />
              </a-form-item>
            </a-col>
            <a-col :span="8">
              <a-form-item class="!mb-0" label-col-flex="50px" label="第四">
                <a-input v-model="configStore.typeTitle[3]" placeholder="请输入该排名称号" allow-clear  @change="configStore.changeConfig" />
              </a-form-item>
            </a-col>
            <a-col :span="8">
              <a-form-item class="!mb-0" label-col-flex="50px" label="第五">
                <a-input v-model="configStore.typeTitle[4]" placeholder="请输入该排名称号" allow-clear  @change="configStore.changeConfig" />
              </a-form-item>
            </a-col>
          </a-row>
        </a-card>
    ...
    <a-card class="flex flex-col flex-auto h-full !ml-1" :hoverable="true" :header-style="{ border: 'none' }"></a-card>
  </div>
</template>
