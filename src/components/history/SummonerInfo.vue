            ...
            <div class="flex items-center justify-between">
              <div class="flex flex-col">
                ...
                <div class="mt-4 flex items-end">
                  ...
                  <span class="ml-3 text-4xl font-semibold"
                        style="color: var(--color-text-1)">{{ currentSummoner.showData.kda }}</span>
                </div>
              </div>
            ...
            <div class="flex items-center justify-between">
              <div class="flex flex-col">
                ...
                <div class="mt-4 flex items-end">
                  ...
                  <span class="ml-3 text-4xl font-semibold"
                        style="color: var(--color-text-1)">{{ currentSummoner.showData.damage }}</span>
                </div>
              </div>
            ...
            <div class="flex items-center justify-between h-full">
              <div class="flex flex-col h-full">
                ...
                <div class="mt-4 flex items-end">
                  ...
                  <span class="ml-3 text-4xl font-semibold "
                        style="color: var(--color-text-1)">{{ currentSummoner.showData.money }}</span>
                </div>
              </div>
          ...
          <block class="flex justify-between w-full py-1.6 cursor-pointer"
            ...
            <div class="w-[100px] flex flex-col px-[1px] items-start justify-center">
              <div
                ...
                ({{ item.participants[0].stats.kills }}/{{ item.participants[0].stats.deaths }}/{{ item.participants[0].stats.assists }})
              </div>
...
const summonerName = route.query.summonerName as string
